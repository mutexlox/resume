...
\section{Experience}
  \textbf{Software Engineering Intern, Site Reliability,} Google
    \hfill Summer 2013
  \begin{itemize} \itemsep -2pt  % reduce space between items
    \item Increased configurability of a program that garbage collects old
            files,\\
          helping increase reliability of systems that serve those files.
    \item Improved accessibility and ease of use of a command-line tool that
            is\\
