...
%  \begin{tabular}{ll}
 ...
 \course{15-418}{Parallel Computer Architecture and Programming}
  {Work with low-level parallel programming constructs like ISPC, CUDA, etc.}{In progress}
...
\section{Experience}
  ...
  \begin{itemize} \itemsep -2pt
      \item Hold office hours, grade student work, write exam questions
      \item Work on course infrastructure and assignments
    \end{itemize}
